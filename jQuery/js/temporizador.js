(function($){
    $.fn.temporizador = function(opcoes){
        ...
        const horaDezena = $('<span class="digito">');
        const horaUnidade = $('<span class="digito">');
        const minutoDezena = $('<span class="digito">');
        const minutoUnidade = $('<span class="digito">');
        const segundoDezena = $('<span class="digito">');
        const segundoUnidade = $('<span class="digito">');
